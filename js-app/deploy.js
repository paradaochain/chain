...
async function main() {
	...
	const dao_wasm = fs
		.readFileSync(path.resolve(__dirname, "../target/ink/dao/dao.wasm"))
		.toString("hex");
	const factory_wasm = fs.readFileSync(
		path.resolve(__dirname, "../target/ink/factory/factory.wasm")
	);
